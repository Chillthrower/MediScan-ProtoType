...
$(document).ready(function() {
    // Call createTextboxes function when the page loads
    createTextboxes();
    
    // Call submitForm function when "Submit" button is clicked
